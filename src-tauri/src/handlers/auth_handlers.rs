...
const DEFAULT_DISCORD_WHITELIST_URL: &str =
    "https://gist.githubusercontent.com/nobodyeuw/d75c8eb99b39fa21fa107704406fab4f/raw/whitelist.json";
...
fn discord_whitelist_url() -> Result<String, String> {
    Ok(
        configured_value("DISCORD_WHITELIST_URL", option_env!("DISCORD_WHITELIST_URL"))
            ...
            .unwrap_or_else(|| DEFAULT_DISCORD_WHITELIST_URL.to_string()),
    )
}
