...
pub const INDEXES: &[&str] = &[
    ...
    "CREATE UNIQUE INDEX IF NOT EXISTS idx_completion_roster_task_unique ON completion_status(roster_id, content_id) WHERE session_id IS NULL AND content_id IN ('ship_shop', 'sea_coin')",
